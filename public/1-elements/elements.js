 ...
 */
function importarAtributs(element, atributs) {
 ...
 */
function crearElement(tag, atributs, node) {
 ...
 * @param element - El elemento a mover.
 */
function moureAnterior(element) {
    const parent = element.parentElement;
...
export { crearNode, crearElement, importarAtributs, aPrimerFill, aUltimFill, moureAnterior, moureSeguent };
