...
const btnPlay = document.getElementById("circle-play") as HTMLButtonElement | null;
const btnReset = document.getElementById("circle-reset") as HTMLButtonElement | null;
const btnShuffle = document.getElementById("circle-shuffle") as HTMLButtonElement | null;
